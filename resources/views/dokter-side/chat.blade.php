...
<body>
    ...
    <main>
        ...
        <h2 class="mt-3 text-center ">Chat</h2>
        ...
        <div class="text-center">
            <div class="btn btn-light" id="add">
                ...
                <a href="/chating/create" style="text-decoration:none">Add</a>
            </div>
            <div class="btn btn-light" id="edit">
                <i class="fa-solid fa-pencil"></i>
                <a href="/chating" style="text-decoration:none">Edit</a>
            </div>
            <div class="btn btn-light" id="hapus">
                <i class="fa-solid fa-calendar-xmark"></i>
                <a href="/hapuschat" style="text-decoration:none">Delete</a>
            </div>
        </div>
    </main>
