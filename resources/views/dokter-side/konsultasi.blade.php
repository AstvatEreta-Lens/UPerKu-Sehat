...
<body>
    ...
    <main>
        ...
        <h2 class="mt-3 text-center ">List Jadwal Konsultasi</h2> <br>
        ...
        <div class="text-center">
            <div class="btn btn-light" id="add">
                ...
                <a href="{{ route('rwt')}}" style="text-decoration:none">Add</a>
                
            </div>
            <div class="btn btn-light" id="edit">
                <i class="fa-solid fa-pencil"></i>
                <a href="/foods" style="text-decoration:none">Edit</a>
            </div>
            <div class="btn btn-light" id="hapus">
                <i class="fa-solid fa-calendar-xmark"></i>
                <a href="/hapus" style="text-decoration:none">Delete</a>
            </div>
        </div>
        <br>
    </main>
