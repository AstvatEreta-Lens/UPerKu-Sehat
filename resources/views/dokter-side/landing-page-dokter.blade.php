...
<body>
  ...
  <![endif]-->    
    ...
    <header class="header-area">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                           ...
                           <a href="/logout" type="button" class="btn btn-primary"><i class="fa fa-sign-out"></i> Logout</a>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(/assets/images/banner-bg-dokter.svg)">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Welcome <strong>{{ Auth::user()->name}}</strong> To</h3>
                            <h2 class="header-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s"> UPerKu Sehat</h2>
                            <p class="text wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                                UPerKu Sehat, sebuah layanan kesehatan inovatif di lingkungan Universitas Pertamina, hadir sebagai platform terpadu yang menyediakan akses cepat dan mudah terhadap 
              ...
              <div class="d-flex row">
                <div class="col-lg-12 d-flex justify-content-center align-items-center ">
                    <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1s">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center pb-40">
                        ...
                        <h3 class="title">Job<br> <span>Fitur Dokter</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Chat Pasien</a></h4>
                            <p class="text">Respon keluhan pasien.</p>
                            <a class="more" href="#">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Jadwal Konsultasi</a></h4>
                            <p class="text">Buat jadwal konsultasi</p>
                            <a class="more" href="#">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Jadwal Temu</a></h4>
                            <p class="text">Buat Jadwal Temu</p>
                            <a class="more" href="#">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Janji Konsultasi</a></h4>
                            <p class="text">Lihat Janji Konsultasi Yang telah dibuat</p>
                            <a class="more" href="#">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Janji Temu</a></h4>
                            <p class="text">Lihat Janji Temu yang telah dibuat</p>
                            <a class="more" href="#">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="services-content mt-30">
                            <h4 class="services-title"><a href="#">Riwayat Pasien</a></h4>
                            <p class="text">Buat Riwayat Pasien</p>
                            <a class="more" href="/dokter/riwayatRekam">See <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single services -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <p class="text">Ribuan Tentara Israel Kena Mental Imbas Perang, Kasus Bunuh Diri Meningkat</p>
                            <a class="more" href="https://health.detik.com/berita-detikhealth/d-7127047/ribuan-tentara-israel-kena-mental-imbas-perang-kasus-bunuh-diri-meningkat">ReadMore <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single blog -->
                </div> 
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="blog-content">
                            ...
                            <a class="more" href="https://health.detik.com/berita-detikhealth/d-7127994/paru-paru-sehat-vs-berpenyakit-ini-ciri-ciri-dan-gejalanya">Read More <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single blog -->
                </div> 
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="blog-content">
                            ...
                            <a class="more" href="https://health.detik.com/berita-detikhealth/d-7128760/polio-muncul-lagi-di-ri-kemenkes-desak-warga-setop-bab-sembarangan">Read More <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single blog -->
                </div> 
            </div> <!-- row -->
