        ...
        <div class="row d-flex flex-row">
            ...
            {{-- <div class=" col ">
                <div class=" ilustrasi border rounded mt-3" style="width:350px;">
                    <img src="/img/ilus-Buat Jandokter.png" class="img-fluid" alt="ilustration">
                </div>
            </div> --}}
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="card me-3" style="width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn btn-primary"><i class="fa fa-handshake-o" aria-hidden="true"></i> Buat Jan</a>
                                            </div>
                                        </div>
                                        <div class="card me-3" style="width: 18rem;">
